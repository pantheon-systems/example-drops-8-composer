...
**[Diffy](https://diffy.website) Visual Regression Testing** can be used to replace BackstopJS testing. For that follow [documentation instructions](https://diffy.website/documentation/pantheon-build-tools) to set up Diffy's integration that uses [CircleCI orb](https://circleci.com/orbs/registry/orb/diffy/diffy). Orb is maintained in [Github repo](https://github.com/DiffyWebsite/diffy-circleci-orb).
